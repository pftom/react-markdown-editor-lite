...
export class MdEditor extends Component {
  ...
  constructor(props) {
    ...
    this.handleImagePaste = this._handleImagePaste.bind(this);
    this.handleImageDrop = this._handleImageDrop.bind(this);
  ...
  onImagePasted(file) {
    const { onImagePaste } = this.props;
    onImagePaste(file, imageUrl => {
      this.handleDecorate("image", { target: file.name, imageUrl });
    });
  }
